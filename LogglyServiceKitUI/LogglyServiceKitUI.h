...
//! Project version number for LogglyServiceKitUI.
FOUNDATION_EXPORT double LogglyServiceKitUIVersionNumber;

//! Project version string for LogglyServiceKitUI.
